...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    /* depresyondan geberiyom. cuma doktora gitcem. 3 haftadır okula gitmiyom. projeyi yapay zekaya yazdırdım.
    tüm kodları o yazdı ben düzenledim sadece. nasıl çalıştığını anlamadığım yerleri sildim. join on gibi keywordlu yeni
    sql sorguları öğrendim. burayı da bitirip duvarı izlemeye devam edicem. */
    ...
    <div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="index.php?tab=coupons&action=add_coupon" method="POST">
                ...
                <div class="mb-3"><label class="block">İndirim Oranı (örn: 0.15)</label><input type="number" step="0.01" min="0.01" max="1" name="discount_rate" required class="w-full p-2 border rounded bg-gray-50"></div>
