...
function get_db_connection() {
    ...
    try {
        ...
        if ($query->fetch() === false) {
            ...
            // 1 admin 1 user 3 firma admin ekle
            ...
            $pdo->exec("INSERT INTO users (fullname, email, password, role, company_id) VALUES ('Kamil Koç Admin', 'kamil@example.com', '$plain_pass', 'Firma Admin', 1)");
            $pdo->exec("INSERT INTO users (fullname, email, password, role, company_id) VALUES ('Metro Admin', 'metro@example.com', '$plain_pass', 'Firma Admin', 2)");
            $pdo->exec("INSERT INTO users (fullname, email, password, role, company_id) VALUES ('Pamukkale Admin', 'pamuk@example.com', '$plain_pass', 'Firma Admin', 3)");

            // her firmaya 2 sefer ekle
            // kamil koç id 1
            ...
            $pdo->exec("INSERT INTO trips (company_id, departure_location, arrival_location, departure_time, price, seat_count) VALUES (1, 'Ankara', 'İstanbul', '2025-10-25 14:00:00', 250.0, 40)");
            ...
            $pdo->exec("INSERT INTO trips (company_id, departure_location, arrival_location, departure_time, price, seat_count) VALUES (2, 'Antalya', 'İzmir', '2025-10-26 18:00:00', 300.0, 42)");
            
            // pamukkale turizm id 3
            $pdo->exec("INSERT INTO trips (company_id, departure_location, arrival_location, departure_time, price, seat_count) VALUES (3, 'Bursa', 'Denizli', '2025-10-27 09:00:00', 280.0, 38)");
            $pdo->exec("INSERT INTO trips (company_id, departure_location, arrival_location, departure_time, price, seat_count) VALUES (3, 'Denizli', 'Bursa', '2025-10-27 16:00:00', 280.0, 38)");
